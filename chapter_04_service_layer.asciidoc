...
******************************************************************************
Why not build out a service for `deallocate`?  We've added an E2E test and a
few stub service-layer tests for you to get started here:
...
* And as we'll see in <<chapter_04b_high_gear_low_gear>>, we've bought
  ourselves the ability to test _edge-to-edge_ and maintain a good-looking
  test pyramid.
